    ...
    class TradeCompleted
      def call(trade)
        { market:                trade.market.id,
          ...
          buyer_uid:             trade.bid_member.uid,
          buyer_income_unit:     trade.market.ask_unit,
          buyer_income_amount:   (trade.volume - trade.volume * trade.bid.fee).to_s('F'),
          ...
          seller_uid:            trade.ask_member.uid,
          seller_income_unit:    trade.market.bid_unit,
          seller_income_amount:  (trade.funds - trade.funds * trade.ask.fee).to_s('F'),
