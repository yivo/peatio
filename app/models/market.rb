...
#
# ID of market is always in the form "#{B}#{A}". For example, in 'btccad'
# market, the commodity pair is `{btc, cad}`. Sellers sell out _btc_ for
# _cad_, buyers buy in _btc_ with _cad_. _btc_ is the `base_unit`, while
# _cad_ is the `quote_unit`.
