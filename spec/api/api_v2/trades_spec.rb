describe APIv2::Trades, type: :request do
  let(:member) do
    create(:verified_member).tap do |m|
      ...
      m.get_account(:cad).update_attributes(balance: 2014.47, locked: 0)
    end
  end
  ...
  describe 'GET /api/v2/trades' do
    it 'should return all recent trades' do
      get '/api/v2/trades', market: 'btccad'
    ...
    it 'should return 1 trade' do
      get '/api/v2/trades', market: 'btccad', limit: 1
    ...
    it 'should return trades before timestamp' do
      ...
      get '/api/v2/trades', market: 'btccad', timestamp: 8.hours.ago.to_i, limit: 1
      expect(response).to be_success
    ...
    it 'should return trades between id range' do
      ...
      get '/api/v2/trades', market: 'btccad', from: ask_trade.id, to: another.id
      expect(response).to be_success
    ...
    it 'should get trades by from and limit' do
      ...
      get '/api/v2/trades', market: 'btccad', from: ask_trade.id, limit: 1, order_by: 'asc'
  ...
  describe 'GET /api/v2/trades/my' do
    it 'should require authentication' do
      get '/api/v2/trades/my', market: 'btccad', access_key: 'test', tonce: time_to_milliseconds, signature: 'test'
    ...
    it 'should return all my recent trades' do
      signed_get '/api/v2/trades/my', params: { market: 'btccad' }, token: token
      expect(response).to be_success
    ...
    it 'should return 1 trade' do
      signed_get '/api/v2/trades/my', params: { market: 'btccad', limit: 1 }, token: token
    ...
    it 'should return trades before timestamp' do
      signed_get '/api/v2/trades/my', params: { market: 'btccad', timestamp: 30.hours.ago.to_i }, token: token
    ...
    it 'should return limit out of range error' do
      signed_get '/api/v2/trades/my', params: { market: 'btccad', limit: 1024 }, token: token
